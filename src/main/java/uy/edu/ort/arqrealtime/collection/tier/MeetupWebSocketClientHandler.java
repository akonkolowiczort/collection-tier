...
class MeetupWebSocketClientHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (!handshaker.isHandshakeComplete()) {
            ...
            finishHandshake((FullHttpResponse) msg, channel);
            return;
        }
        ...
        if (frame instanceof TextWebSocketFrame) {
            processWebSocketFrame((TextWebSocketFrame) frame);
    ...
    private void finishHandshake(FullHttpResponse msg, Channel channel) {
        handshaker.finishHandshake(channel, msg);
        handshakeFuture.setSuccess();
        System.out.println("WebSocket Client connected and ready to consume RSVPs!");
    }

    private void processWebSocketFrame(TextWebSocketFrame textFrame) throws Exception {
